...
local function hud_main()
    ...
    if GetGlobalBool("DarkRP_LockDown") then
        ...
        draw.RoundedBox( config.Radius, x - 820, 35, 300, 18, config.basecolor )
        surface.SetDrawColor( Color( 255, sin * 255, sin * 255 ) )
        surface.DrawOutlinedRect( x - 820, 35, 300, 18 ) 
        draw.SimpleText( config.lockdown_text ,"ui.39", x - 800, 35, Color( 255, sin * 255, sin * 255 ) )       
